defmodule DemoWeb.CoreComponents do
  ...
  def dropdown(assigns) do
    ...
    <div
      ...
      phx-focus={open_dropdown(@on_open, @id)}
      phx-blur={@on_blur}
      tabindex="0"
    >
      <div class={[
      ...
      <div
        ...
        class={[
          "w-full invisible opacity-0 h-0 py-2 px-4 absolute bg-white z-10",
          "border rounded-t-none rounded-lg border-t-0",
          "text-zinc-900 ring-0 sm:text-sm sm:leading-6",
          "group-data-[ui-open]/dropdown:border-zinc-400",
          "group-data-[ui-open]/dropdown:h-auto",
          "group-data-[ui-open]/dropdown:visible",
          "group-data-[ui-open]/dropdown:opacity-100",
  ...
  def spinner(assigns) do
    ...
    <div role="status">
      <svg
        ...
        class={[
          "w-#{@size} h-#{@size}",
          "text-gray-300 animate-spin fill-blue-500"
        ]}
        viewBox="0 0 100 101"
        fill="none"
  ...
  def close_dropdown(id) do
    ...
    |> JS.dispatch("clear-search-input")
  end
